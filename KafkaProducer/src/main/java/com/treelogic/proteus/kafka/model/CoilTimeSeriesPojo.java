...
public class CoilTimeSeriesPojo<T> implements Serializable {
    ...
    // Example
    // 40414156,3289.0,0.0,20595.822,0.0,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N,\N
    // Total = 46
    // Posicion X + Posicion Y + Value + 43
    ...
    */
    ...
    public static class ProteusPojo {
